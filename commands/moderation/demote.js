...
/*
    ...
    I'm gonna talking french in this file, so i'll let you traduce what you need to traduce.
    I'll write all informations you need for that operation.
*/
...
module.exports.run = (message, args, client, prefix) => {
    if ((args[0] ||'help').toLowerCase() === 'help') {
        //Here I send help page
        const help = new Discord.MessageEmbed()
            .setTimestamp()
            .setColor(message.guild.me.displayHexColor)
            .setFooter(message.author.username, message.author.avatarURL({ dynamic: true }))
            // Warning: Here you maybe haven't the variable "prefix", so make sure that she is defined
            // You just can define that like this: const prefix = 's?';
